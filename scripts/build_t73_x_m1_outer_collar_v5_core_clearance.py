#!/usr/bin/env python3
"""Apply the shared exact semantic engine to V5 collar cores."""
...
from build_t73_x_m1_outer_collar_v4_core_clearance import build as build_versioned
...
OUTPUT = ROOT / "audit/t73_x_m1_outer_collar_v5_core_clearance.json"
...
def main():
    ...
    if args.check and json.loads(OUTPUT.read_text()) != result:
        raise AssertionError("v5 core clearance is stale")
    print(
        json.dumps(
            {
