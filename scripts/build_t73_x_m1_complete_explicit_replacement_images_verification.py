#!/usr/bin/env python3
"""Persist the first full independent replay of the explicit replacement stream."""
...
from verify_t73_x_m1_complete_explicit_replacement_images import DATA, verify_full


ROOT = Path(__file__).resolve().parents[1]
VERIFIER = ROOT / "scripts/verify_t73_x_m1_complete_explicit_replacement_images.py"
OUTPUT = ROOT / "audit/t73_x_m1_complete_explicit_replacement_images_verification.json"
...
def main() -> None:
    ...
    verification = {
        "schema": "t73_x_m1_complete_explicit_replacement_images_verification/v1",
