...
def verify():
 ...
 if (d["component_count"],d["framed_core_segment_count"],d["framed_push_segment_count"],d["dotted_polygon_segment_count"],d["passage_mapping_cylinder_tetrahedra"])!=(7,80007,84383,8,21408):raise AssertionError("dotted atlas totals changed")
