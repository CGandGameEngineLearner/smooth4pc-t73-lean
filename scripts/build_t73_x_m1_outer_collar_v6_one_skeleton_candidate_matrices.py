#!/usr/bin/env python3
"""Build all V6 one-skeleton matrices with the shared exact R-tree engine."""
...
LOCAL_VERIFY = (
    ROOT / "audit/t73_x_m1_framed_outer_interface_collars_v6_verification.json"
)
OUTPUT = ROOT / "audit/t73_x_m1_outer_collar_v6_one_skeleton_candidate_matrices.json"


def build():
    return build_versioned(COLLARS, LOCAL_VERIFY, "v6")
...
def main():
    ...
    if args.check and json.loads(OUTPUT.read_text()) != result:
        raise AssertionError("v6 one-skeleton matrices are stale")
    print(
        json.dumps(
            {
