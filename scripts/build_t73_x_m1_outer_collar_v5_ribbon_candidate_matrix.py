#!/usr/bin/env python3
"""Build the V5 ribbon matrix after complete one-skeleton clearance."""
...
ONE_SKELETON = ROOT / "audit/t73_x_m1_outer_collar_v5_core_push_clearance.json"
OUTPUT = ROOT / "audit/t73_x_m1_outer_collar_v5_ribbon_candidate_matrix.json"


def build():
    return build_versioned(COLLARS, ONE_SKELETON, "v5")
...
def main():
    ...
    if args.check and json.loads(OUTPUT.read_text()) != result:
        raise AssertionError("v5 ribbon candidate matrix is stale")
    print(
        json.dumps(
            {
