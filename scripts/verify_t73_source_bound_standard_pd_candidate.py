...
def verify() -> dict:
    ...
    if data["railroad_core_coordinates_sha256"] != core["sha256"] or data["actual_railroad_word_binding_sha256"] != railroad["sha256"] or data["final_yz_foot_state_sha256"] != foot_state["sha256"] or data["railroad_product_framings_sha256"] != framings["sha256"]:
