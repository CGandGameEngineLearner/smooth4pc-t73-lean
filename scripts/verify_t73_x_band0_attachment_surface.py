...
def verify() -> dict:
    ...
    if data["completion_status"] != "X_BAND0_ACTUAL_ATTACHMENTS_CANDIDATE_FRAMING_INTERIOR":
    ...
    return {
        "verdict": "PASS_X_BAND0_ACTUAL_ATTACHMENTS_CANDIDATE_FRAMING_INTERIOR",
