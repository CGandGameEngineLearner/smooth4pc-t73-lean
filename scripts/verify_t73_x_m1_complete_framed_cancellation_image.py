...
def verify():
    ...
    expected = {"m_2": (12087, 10760, 1327, 13428, 14044, 14755, 15371), "m_3": (55891, 49600, 6291, 60540, 64284, 66831, 70575), "r_xy": (84, 80, 4, 94, 102, 98, 106), "r_yz": (8, 0, 8, 0, 0, 8, 8), "r_zx": (84, 80, 4, 94, 102, 98, 106)}
    ...
    if totals != (68154, 60520, 74156, 78532, 81790, 86166): raise AssertionError("complete cancellation-image totals changed")
    ...
    return {"verdict": "PASS_COMPLETE_X_M1_FRAMED_CANCELLATION_IMAGE_IN_ATLAS", "components": 5, "source_core_segments": 68154, "target_core_segments": 81790, "target_push_segments": 86166, "overlap_transitions": 3026, "single_affine_s3_chart_status": "OPEN"}
