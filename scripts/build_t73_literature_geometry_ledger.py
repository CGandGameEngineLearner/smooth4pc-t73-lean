...
def build():
 ...
 {'id':'AR84_minimal_straightening','citation':'Aitchison--Rubinstein (1984), Lemma 3.2 and its proof','url':'https://math.berkeley.edu/~kirby/papers/Gordon%20and%20Kirby%20%28editors%29%20-%20Four-manifold%20theory%20%28Durham%29%20-%20MR0780574.pdf','pages':['11','12'],'anchors':['Lemma 3.2','Figure 7','Figure 8'],'supports':['explicit parameterised linear matrix isotopies for canonical-form Cappell--Shaneson matrices','fixed-point minimal straightening'],'extractable_formulae':['A_s = [[0,0,1],[m-ms,lambda,0],[n-ns,p,nu]]','A_1t = [[0,0,1],[0,lambda-lambda*t,0],[-1,p-pt,nu-vt]]','A_11r = [[r,0,1-r],[0,1,0],[r-1,0,r]]'],'does_not_supply':['T73 conjugating matrix and all chart-to-Kirby foot identifications']},
