#!/usr/bin/env python3
"""Apply exact ruled-rectangle clearance to V6 collars."""
...
MATRIX = ROOT / "audit/t73_x_m1_outer_collar_v6_ribbon_candidate_matrix.json"
OUTPUT = ROOT / "audit/t73_x_m1_outer_collar_v6_ribbon_clearance.json"


def build():
    return build_versioned(COLLARS, MATRIX, "v6")
...
def main():
    ...
    if args.check and json.loads(OUTPUT.read_text()) != result:
        raise AssertionError("v6 ribbon clearance is stale")
    print(
        json.dumps(
            {
