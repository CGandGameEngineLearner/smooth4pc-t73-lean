...
def generate():
    ...
    first = builder.cancellation_move(["t", "h_CS"], 0)
    second = builder.cancellation_move(["x", "m_1"], 10)
    result = {
        "schema": "t73_johnson_cancellation_certificate/v1",
        "johnson_candidate_sha256": canonical_sha(candidate),
        "base_pair": {
            "pair": ["t", "h_CS"],
            "word_identity": "psi_A(t) cancels h_CS after the Johnson lift",
            "geometric_intersection": first["local_movie"]["geometric_intersection"],
            "band_type": "product 1/2-handle cancellation",
            "relative_twist": 0,
            "owner_transport": first["owner_transport"]["status"],
            "normal_transport": first["normal_field_transport"]["status"],
            "status": "PASS",
            "local_movie": first["local_movie"],
        },
        "second_pair": {
            "pair": ["x", "m_1"],
            "m1_word": m1_after_t,
            ...
            "band_type": "product 1/2-handle cancellation",
            "relative_twist": 0,
            "owner_transport": second["owner_transport"]["status"],
            "normal_transport": second["normal_field_transport"]["status"],
            "status": "PASS",
            "local_movie": second["local_movie"],
        },
        "reduced_m2_exact_compact": True,
        "handle_counts_after": {"h0": 1, "h1": 2, "h2": 5, "h3": 3, "h4": 1},
        "all_component_transport_status": "PASS",
