#!/usr/bin/env python3
"""Persist a full independent replay of all canonical-R3 middle paths."""
...
from verify_t73_x_m1_middle_paths_r3 import DATA, verify_full


ROOT = Path(__file__).resolve().parents[1]
VERIFIER = ROOT / "scripts/verify_t73_x_m1_middle_paths_r3.py"
OUTPUT = ROOT / "audit/t73_x_m1_middle_paths_r3_verification.json"
...
def main():
    ...
    verification = {
        "schema": "t73_x_m1_middle_paths_r3_verification/v1",
