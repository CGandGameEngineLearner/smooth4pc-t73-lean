...
def check() -> None:
    ...
    require(paper_text, r"\begin{theorem}[Trace-73 theorem]\label{thm:joined}", paper)
    ...
    if audit["overall"] != "PASS_MATHEMATICAL_LEAN_PARTIAL" or not audit["counterexample_claim_proved"]:
        raise AssertionError("mathematical theorem is not discharged")
...
def main() -> None:
    check()
    print("T73_COMPLETION=MATHEMATICAL_PASS_LEAN_PARTIAL")
