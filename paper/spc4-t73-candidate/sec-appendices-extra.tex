...
\section{The counterfactual literal-split grading ledger}\label{app:grading}

The following table applies to the abstract split target only.  The saved
source endpoint matching fails its premise, so the total does not determine
the actual degree $q_C$.
...
\midrule
$-227$ & normalized coefficient versus two normalized $\mathcal C_{271}$ Hom factors & $(44+271)-2\cdot271=-227$\\
$+227$ & convert $\mathcal C_{271}$ Hom to $\mathcal C_{44}$ Hom plus split circles & $271-44=227$\\
