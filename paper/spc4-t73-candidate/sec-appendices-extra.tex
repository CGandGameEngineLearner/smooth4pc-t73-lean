...
were opened.  Their use in the Johnson replacement is discharged by P0 and
\texttt{scripts/reconstruct\_t73\_p0.py}, not by the unavailable historical
PD.
...
\path{output/pdf/spc4-t73-candidate.pdf}.  The retired manuscript
\path{paper/t73_candidate.tex} remains in the repository as a historical
ledger only; it is not the controlling document.
