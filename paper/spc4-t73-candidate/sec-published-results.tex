...
Lemma~\ref{lem:Ssystem} for kernel invariance.  The current
Horvat--Jab\l onowski preprint, dated 24 August 2026, contains Lemma~5.5
(the spotted-ball slide lemma) and Lemma~5.7 (relative uniqueness of
complete sphere systems).  Neither lemma is invoked in the Johnson
