...
The integer $2624$ is the value of the geometry-bound truncated Burau
computation on the actual detector braid, not an identified MWW divided cubic.
...
endpoints of \eqref{eq:u} and \eqref{eq:ell}.  The integer is a geometry-bound Burau
...
paired-support boundary remains \Open.
...
the $93$ ambient Johnson handle slides remains \Open.
