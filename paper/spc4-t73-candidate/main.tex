...
the truncated Burau value is $2624$.  That integer is presently only the
value of this geometry-bound Burau computation; it is not identified with an MWW
...
geometry-bound Burau value.  It does not close C or S.
