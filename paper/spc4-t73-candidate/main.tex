...
inhabitant, so no counterexample is claimed.
...
P3/E12 & \Discharged & Empty-link Khovanov over $\mathbb Q$, PL $S^4=I^4\cup_{S^3}I^4$ of Euler characteristic $2$, MWW Proposition~3.4; quantum degree $494$ vanishes.  Lean \texttt{S4ReductionData} remains uninhabited. \\
...
\texttt{s4DegreeZero} & E12 computed empty Khovanov and standard $S^4$ from two $I^4$; \texttt{S4ReductionData} uninhabited. \\
...
\texttt{ExternalGeometry} is uninhabited.  The Lean theorem consumes no
stronger statement, and it records the
