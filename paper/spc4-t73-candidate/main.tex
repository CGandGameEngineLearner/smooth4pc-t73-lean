...
September assumption register, and the reproduction commands for this
manuscript.
\end{abstract}
...
replaced by narrative JSON fields or terminal status strings.  The controlling
manuscript is the present \path{main.tex}.
