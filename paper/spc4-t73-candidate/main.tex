...
If the remaining four-handle identification P3 were supplied as an
...
\]
P0, C and S are discharged for the Johnson replacement; P3 is not.
...
inhabitant of \texttt{ExternalGeometry}.  P3 remains Open, so the remaining
...
Hypothesis~\ref{hyp:P3} remains Open, so the identification of the
iterated quotient with $\mathcal S^2_0(\Sigma_A^0)$ is not proved.  $\det(A-I)=1$ remains the finite homotopy-sphere criterion
...
P3/E11 & \Open & MWW Proposition~3.4 remains conditional on the four-handle identification. \\
...
as discharged for the Johnson replacement reversed picture, and should treat
Hypothesis~\ref{hyp:P3} as Open.

\section{Conclusion}

P0, C and S are discharged for the explicit Johnson replacement.
P3 remains Open, so Theorem~\ref{thm:A} and Lean's
