...
For that final collar, joining the residual balls by the shortest dual-face
path and adding one agreement layer gives candidate subcomplexes of sizes
$129,125,180,179$.  They collapse to a point and stay at least distance $1$
from every protected-ball centre.  The first, second and fourth have manifold
sphere boundary; the $180$-tetrahedron positive prefix-first candidate has one
edge of multiplicity four and is rejected.  All four remain insufficient:
even for the three ball supports, the partition of their common boundary
circles among disk and annulus components differs between source and target,
so no boundary-fixed homeomorphism has yet been supplied.  The discrepancy is finite: in the
...
map would be one or two sphere half-turns.  For the three manifold candidates
the loop permutation also preserves the sphere nesting tree.  A subdivided
regular neighbourhood is still needed for positive prefix-first; placing the
loop half-turns and fixed-boundary polar collars remains \Open in every case.
