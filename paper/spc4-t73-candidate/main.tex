...
\begin{proof}
There is a Freudenthal triangulation of Johnson's period-one torus on which
the affine map $S$ is a simplex-by-simplex map onto a triangulation of the
period-two torus, carrying each Johnson spine $1$-simplex onto the
corresponding AR coordinate spine.  Because the linear part is $2I$,
Euclidean distances scale by $2$, so Johnson's Voronoi handlebodies map onto
Voronoi cells of the image spines.  The protected ball of radius
$1/196104$ about $0$ maps to the ball of radius $2/196104$ about $Q$.  A
discrete Voronoi Heegaard pair on a $384$-tetrahedron torus is certified, and
$T(v)=v-(1,1,1)$ carries the Johnson pair onto it.
\end{proof}
