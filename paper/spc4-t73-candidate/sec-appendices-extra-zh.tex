...
在第~\ref{sec:exact-algebra} 节的约定下，系数向量
...
\section{历史单-Hom 分次账本}\label{app:grading}

下表的 $494$ 是被取代路线的形式算术，不是实际 MWW 类的已证次数。目标端
literal-split 的另一形式账本为 $223$，但完整源端匹配否定该 split；因此两者
均不能作为当前结论。
