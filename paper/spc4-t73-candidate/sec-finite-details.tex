...
\eqref{eq:ell-eps-series}, so $D_3([v_T])=(-2)^3(-328)=2624$.
\end{proof}
...
\begin{proposition}[Corrected split-route quantum degree]\label{prop:degree-223}
Assuming the relative two-representable split of Hypothesis~\ref{hyp:P1}, the
...
citations and transports the degree-$223$ class through the four-handle
