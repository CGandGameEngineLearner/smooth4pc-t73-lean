...
SCRIPT = (
    ROOT / "scripts/verify_t73_x_m1_outer_collar_v7_sequential_static_core_clearance.py"
)


class OuterCollarV7SequentialStaticCoreClearanceTest(unittest.TestCase):
    def test_saved_ordered_mixed_core_clearance(self):
