...
SCRIPT = ROOT / "scripts/build_t73_x_m1_outer_collar_v3_core_clearance.py"


class OuterCollarV3CoreClearanceTest(unittest.TestCase):
    def test_complete_semantic_matrix_is_closed(self):
        ...
        self.assertEqual(result["semantic_type_pair_count"], 11)
