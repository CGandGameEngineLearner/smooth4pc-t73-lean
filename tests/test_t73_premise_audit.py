...
class PremiseAuditTest(unittest.TestCase):
    ...
    def test_load_bearing_geometry_is_open(self) -> None:
        ...
        self.assertEqual(audit["items"]["C"]["state"], "PASS")
        self.assertTrue(audit["items"]["C"]["proved"])
        self.assertEqual(audit["items"]["S"]["state"], "PASS")
        self.assertTrue(audit["items"]["S"]["proved"])
        self.assertFalse(audit["items"]["S"]["falsified"])
        self.assertEqual(audit["items"]["P3_E11"]["state"], "PASS")
        self.assertTrue(audit["items"]["P3_E11"]["proved"])
        self.assertEqual(audit["items"]["P3_E12"]["state"], "PASS")
        self.assertTrue(audit["items"]["P3_E12"]["proved"])
        self.assertEqual(audit["items"]["P3_E13"]["state"], "PARTIAL")
        self.assertFalse(audit["items"]["P3_E13"]["proved"])
